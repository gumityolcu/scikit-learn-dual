...
from sklearn_dual.cluster import (
    OPTICS,
    AffinityPropagation,
    Birch,
    MeanShift,
...
from sklearn_dual.exceptions import ConvergenceWarning, FitFailedWarning

# make it possible to discover experimental estimators when calling `all_estimators`
from sklearn_dual.experimental import (
    enable_halving_search_cv,  # noqa
    enable_iterative_imputer,  # noqa
)
from sklearn_dual.linear_model import LogisticRegression, Ridge
from sklearn_dual.linear_model._base import LinearClassifierMixin
from sklearn_dual.manifold import TSNE, Isomap, LocallyLinearEmbedding
...
from sklearn_dual.neighbors import (
...
from sklearn_dual.semi_supervised import LabelPropagation, LabelSpreading
from sklearn_dual.utils import all_estimators
from sklearn_dual.utils._tags import _DEFAULT_TAGS, _safe_tags
