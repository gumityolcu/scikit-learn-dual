...
from sklearn_dual.datasets import fetch_openml as fetch_openml_orig
from sklearn_dual.datasets._openml import (
    _OPENML_PREFIX,
    _get_local_path,
    _open_openml_url,
...
from sklearn_dual.utils._optional_dependencies import check_pandas_support
