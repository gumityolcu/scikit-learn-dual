...
from sklearn_dual import clone, datasets, tree
...
from sklearn_dual.metrics import accuracy_score, mean_poisson_deviance, mean_squared_error
from sklearn_dual.model_selection import cross_val_score, train_test_split
from sklearn_dual.pipeline import make_pipeline
from sklearn_dual.random_projection import _sparse_random_matrix
from sklearn_dual.tree import (
    DecisionTreeClassifier,
    DecisionTreeRegressor,
    ExtraTreeClassifier,
    ExtraTreeRegressor,
)
from sklearn_dual.tree._classes import (
    CRITERIA_CLF,
    CRITERIA_REG,
    DENSE_SPLITTERS,
    SPARSE_SPLITTERS,
)
from sklearn_dual.tree._tree import (
    NODE_DTYPE,
    TREE_LEAF,
    TREE_UNDEFINED,
    _check_n_classes,
...
from sklearn_dual.tree._tree import Tree as CythonTree
from sklearn_dual.utils import compute_sample_weight
from sklearn_dual.utils._testing import (
    assert_almost_equal,
...
from sklearn_dual.utils.estimator_checks import check_sample_weights_invariance
from sklearn_dual.utils.fixes import (
    _IS_32BIT,
    COO_CONTAINERS,
    CSC_CONTAINERS,
    CSR_CONTAINERS,
...
def test_realloc():
    from sklearn_dual.tree._utils import _realloc_test
