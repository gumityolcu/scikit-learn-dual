...
def silhouette_score(
    ...
    **kwds : optional keyword parameters
    ...
    >>> from sklearn_dual.metrics import silhouette_score
...
def silhouette_samples(X, labels, *, metric="euclidean", **kwds):
    ...
    **kwds : optional keyword parameters
    ...
    Examples
    --------
    >>> from sklearn_dual.metrics import silhouette_samples
    >>> from sklearn_dual.datasets import make_blobs
    >>> from sklearn_dual.cluster import KMeans
...
def calinski_harabasz_score(X, labels):
    ...
    >>> from sklearn_dual.datasets import make_blobs
    >>> from sklearn_dual.cluster import KMeans
    >>> from sklearn_dual.metrics import calinski_harabasz_score
...
def davies_bouldin_score(X, labels):
    ...
    Examples
    --------
    >>> from sklearn_dual.metrics import davies_bouldin_score
    >>> X = [[0, 1], [1, 1], [3, 4]]
    >>> labels = [0, 0, 1]
