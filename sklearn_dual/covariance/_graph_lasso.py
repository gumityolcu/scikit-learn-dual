...
def graphical_lasso(
    ...
    *,
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_dual.datasets import make_sparse_spd_matrix
    >>> from sklearn_dual.covariance import empirical_covariance, graphical_lasso
...
class GraphicalLasso(BaseGraphicalLasso):
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_dual.covariance import GraphicalLasso
...
class GraphicalLassoCV(BaseGraphicalLasso):
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_dual.covariance import GraphicalLassoCV
    >>> true_cov = np.array([[0.8, 0.0, 0.2, 0.0],
    ...                      [0.0, 0.4, 0.0, 0.0],
    ...                      [0.2, 0.0, 0.3, 0.1],
    ...                      [0.0, 0.0, 0.1, 0.7]])
