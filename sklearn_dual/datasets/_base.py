...
def clear_data_home(data_home=None):
    ...
    Examples
    --------
    >>> from sklearn_dual.datasets import clear_data_home
...
def load_files(
    ...
    *,
    ...
    Examples
    --------
    >>> from sklearn_dual.datasets import load_files
    >>> container_path = "./"
...
def load_linnerud(*, return_X_y=False, as_frame=False):
    ...
    Examples
    --------
    >>> from sklearn_dual.datasets import load_linnerud
...
def load_sample_images():
    ...
    >>> from sklearn_dual.datasets import load_sample_images
