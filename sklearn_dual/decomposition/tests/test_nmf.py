...
from sklearn_dual.decomposition import NMF, MiniBatchNMF, non_negative_factorization
from sklearn_dual.decomposition import _nmf as nmf  # For testing internals
...
from sklearn_dual.utils.extmath import squared_norm
