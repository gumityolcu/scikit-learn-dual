...
class MaxAbsScaler(OneToOneFeatureMixin, TransformerMixin, BaseEstimator):
    ...
    Examples
    --------
    >>> from sklearn_dual.preprocessing import MaxAbsScaler
    >>> X = [[ 1., -1.,  2.],
    ...      [ 2.,  0.,  0.],
    ...      [ 0.,  1., -1.]]
...
def maxabs_scale(X, *, axis=0, copy=True):
    ...
    Examples
    --------
    >>> from sklearn_dual.preprocessing import maxabs_scale
    >>> X = [[-2, 1, 2], [-1, 0, 1]]
...
class RobustScaler(OneToOneFeatureMixin, TransformerMixin, BaseEstimator):
    ...
    Examples
    --------
    >>> from sklearn_dual.preprocessing import RobustScaler
    >>> X = [[ 1., -2.,  2.],
    ...      [ -2.,  1.,  3.],
    ...      [ 4.,  1., -2.]]
...
def robust_scale(
    ...
    *,
    ...
    Examples
    --------
    >>> from sklearn_dual.preprocessing import robust_scale
    >>> X = [[-2, 1, 2], [-1, 0, 1]]
...
def normalize(X, norm="l2", *, axis=1, copy=True, return_norm=False):
    ...
    Examples
    --------
    >>> from sklearn_dual.preprocessing import normalize
    >>> X = [[-2, 1, 2], [-1, 0, 1]]
...
def binarize(X, *, threshold=0.0, copy=True):
    ...
    Examples
    --------
    >>> from sklearn_dual.preprocessing import binarize
...
class Binarizer(OneToOneFeatureMixin, TransformerMixin, BaseEstimator):
    ...
    Examples
    --------
    >>> from sklearn_dual.preprocessing import Binarizer
    >>> X = [[ 1., -1.,  2.],
    ...      [ 2.,  0.,  0.],
    ...      [ 0.,  1., -1.]]
...
class KernelCenterer(ClassNamePrefixFeaturesOutMixin, TransformerMixin, BaseEstimator):
    ...
    Examples
    --------
    >>> from sklearn_dual.preprocessing import KernelCenterer
...
def add_dummy_feature(X, value=1.0):
    ...
    Examples
    --------
    >>> from sklearn_dual.preprocessing import add_dummy_feature
...
class PowerTransformer(OneToOneFeatureMixin, TransformerMixin, BaseEstimator):
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_dual.preprocessing import PowerTransformer
    >>> pt = PowerTransformer()
    >>> data = [[1, 2], [3, 2], [4, 5]]
    >>> print(pt.fit(data))
    PowerTransformer()
...
def power_transform(X, method="yeo-johnson", *, standardize=True, copy=True):
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_dual.preprocessing import power_transform
    >>> data = [[1, 2], [3, 2], [4, 5]]
