...
from sklearn_dual import config_context, get_config
from sklearn_dual.base import BaseEstimator, ClassifierMixin, OutlierMixin
...
from sklearn_dual.exceptions import ConvergenceWarning, SkipTestWarning
...
from sklearn_dual.svm import SVC, NuSVC
from sklearn_dual.utils import _array_api, all_estimators, deprecated
from sklearn_dual.utils._param_validation import Interval, StrOptions
...
from sklearn_dual.utils.estimator_checks import (
    _NotAnArray,
...
from sklearn_dual.utils.fixes import CSR_CONTAINERS, SPARRAY_PRESENT
from sklearn_dual.utils.metaestimators import available_if
from sklearn_dual.utils.validation import check_array, check_is_fitted, check_X_y
...
class BadBalancedWeightsClassifier(BaseBadClassifier):
    ...
    def fit(self, X, y):
        from sklearn_dual.preprocessing import LabelEncoder
        from sklearn_dual.utils import compute_class_weight
