...
class OPTICS(ClusterMixin, BaseEstimator):
    ...
    Examples
    --------
    >>> from sklearn_dual.cluster import OPTICS
    >>> import numpy as np
...
def compute_optics_graph(
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_dual.cluster import compute_optics_graph
    >>> X = np.array([[1, 2], [2, 5], [3, 6],
    ...               [8, 7], [8, 8], [7, 3]])
...
def cluster_optics_dbscan(*, reachability, core_distances, ordering, eps):
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_dual.cluster import cluster_optics_dbscan, compute_optics_graph
    >>> X = np.array([[1, 2], [2, 5], [3, 6],
    ...               [8, 7], [8, 8], [7, 3]])
    >>> ordering, core_distances, reachability, predecessor = compute_optics_graph(
    ...     X,
...
def cluster_optics_xi(
    *,
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_dual.cluster import cluster_optics_xi, compute_optics_graph
    >>> X = np.array([[1, 2], [2, 5], [3, 6],
    ...               [8, 7], [8, 8], [7, 3]])
    >>> ordering, core_distances, reachability, predecessor = compute_optics_graph(
    ...     X,
