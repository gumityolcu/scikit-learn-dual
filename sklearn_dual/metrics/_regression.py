...
def root_mean_squared_log_error(
    ...
    Examples
    --------
    >>> from sklearn_dual.metrics import root_mean_squared_log_error
    >>> y_true = [3, 5, 2.5, 7]
    >>> y_pred = [2.5, 5, 4, 8]
...
def mean_poisson_deviance(y_true, y_pred, *, sample_weight=None):
    ...
    Examples
    --------
    >>> from sklearn_dual.metrics import mean_poisson_deviance
    >>> y_true = [2, 0, 1, 4]
    >>> y_pred = [0.5, 0.5, 2., 2.]
...
def mean_gamma_deviance(y_true, y_pred, *, sample_weight=None):
    ...
    Examples
    --------
    >>> from sklearn_dual.metrics import mean_gamma_deviance
    >>> y_true = [2, 0.5, 1, 4]
    >>> y_pred = [0.5, 0.5, 2., 2.]
...
def d2_tweedie_score(y_true, y_pred, *, sample_weight=None, power=0):
    ...
    Examples
    --------
    >>> from sklearn_dual.metrics import d2_tweedie_score
    >>> y_true = [0.5, 1, 2.5, 7]
    >>> y_pred = [1, 1, 5, 3.5]
...
def d2_pinball_score(
    ...
    Examples
    --------
    >>> from sklearn_dual.metrics import d2_pinball_score
    >>> y_true = [1, 2, 3]
    >>> y_pred = [1, 3, 3]
