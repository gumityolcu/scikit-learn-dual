...
from sklearn_dual.datasets import load_iris, make_classification
from sklearn_dual.exceptions import ConvergenceWarning
from sklearn_dual.linear_model import SGDClassifier
from sklearn_dual.linear_model._logistic import (
...
from sklearn_dual.metrics import get_scorer, log_loss
...
from sklearn_dual.preprocessing import LabelEncoder, StandardScaler, scale
from sklearn_dual.svm import l1_min_c
from sklearn_dual.utils import compute_class_weight, shuffle
from sklearn_dual.utils._testing import ignore_warnings, skip_if_no_parallel
