...
def get_scorer_names():
    ...
    Examples
    --------
    >>> from sklearn_dual.metrics import get_scorer_names
...
def check_scoring(estimator=None, scoring=None, *, allow_none=False, raise_exc=True):
    ...
    >>> from sklearn_dual.metrics import check_scoring
    ...
    >>> from sklearn_dual.metrics import make_scorer, accuracy_score, mean_squared_log_error
    >>> X, y = load_iris(return_X_y=True)
    >>> y *= -1
