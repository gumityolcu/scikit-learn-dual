...
def orthogonal_mp(
    ...
    *,
    ...
    >>> from sklearn_dual.linear_model import orthogonal_mp
...
def orthogonal_mp_gram(
    ...
    *,
    ...
    --------
    >>> from sklearn_dual.datasets import make_regression
    >>> from sklearn_dual.linear_model import orthogonal_mp_gram
    >>> X, y = make_regression(noise=4, random_state=0)
...
class OrthogonalMatchingPursuit(MultiOutputMixin, RegressorMixin, LinearModel):
    ...
    Examples
    --------
    >>> from sklearn_dual.linear_model import OrthogonalMatchingPursuit
    >>> from sklearn_dual.datasets import make_regression
    >>> X, y = make_regression(noise=4, random_state=0)
...
class OrthogonalMatchingPursuitCV(RegressorMixin, LinearModel):
    ...
    Examples
    --------
    >>> from sklearn_dual.linear_model import OrthogonalMatchingPursuitCV
    >>> from sklearn_dual.datasets import make_regression
