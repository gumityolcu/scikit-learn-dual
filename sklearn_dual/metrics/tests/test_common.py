...
from sklearn_dual.metrics._base import _average_binary_score
from sklearn_dual.metrics.pairwise import (
...
from sklearn_dual.utils.fixes import COO_CONTAINERS, parse_version, sp_version
from sklearn_dual.utils.multiclass import type_of_target
from sklearn_dual.utils.validation import _num_samples, check_random_state
