...
def sparse_encode(
    ...
    *,
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_dual.decomposition import sparse_encode
...
def dict_learning_online(
    ...
    *,
    ...
    >>> from sklearn_dual.decomposition import dict_learning_online
...
def dict_learning(
    ...
    *,
    ...
    >>> import numpy as np
    >>> from sklearn_dual.datasets import make_sparse_coded_signal
    >>> from sklearn_dual.decomposition import dict_learning
    >>> X, _, _ = make_sparse_coded_signal(
    ...     n_samples=30, n_components=15, n_features=20, n_nonzero_coefs=10,
    ...     random_state=42,
    ... )
...
class DictionaryLearning(_BaseSparseCoding, BaseEstimator):
    ...
    >>> import numpy as np
    >>> from sklearn_dual.datasets import make_sparse_coded_signal
    >>> from sklearn_dual.decomposition import DictionaryLearning
