...
from sklearn_dual.datasets import load_diabetes, load_iris, make_classification
from sklearn_dual.ensemble import IsolationForest
from sklearn_dual.ensemble._iforest import _average_path_length
from sklearn_dual.metrics import roc_auc_score
from sklearn_dual.model_selection import ParameterGrid, train_test_split
