...
class RBFSampler(ClassNamePrefixFeaturesOutMixin, TransformerMixin, BaseEstimator):
    ...
    Examples
    --------
    >>> from sklearn_dual.kernel_approximation import RBFSampler
    >>> from sklearn_dual.linear_model import SGDClassifier
    >>> X = [[0, 0], [1, 1], [1, 0], [0, 1]]
    >>> y = [0, 0, 1, 1]
...
class SkewedChi2Sampler(
    ...
    Examples
    --------
    >>> from sklearn_dual.kernel_approximation import SkewedChi2Sampler
    >>> from sklearn_dual.linear_model import SGDClassifier
    >>> X = [[0, 0], [1, 1], [1, 0], [0, 1]]
    >>> y = [0, 0, 1, 1]
...
class AdditiveChi2Sampler(TransformerMixin, BaseEstimator):
    ...
    >>> from sklearn_dual.linear_model import SGDClassifier
    >>> from sklearn_dual.kernel_approximation import AdditiveChi2Sampler
