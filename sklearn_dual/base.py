...
class RegressorMixin:
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_dual.base import BaseEstimator, RegressorMixin
    >>> # Mixin classes should always be on the left-hand side for a correct MRO
...
class ClusterMixin:
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_dual.base import BaseEstimator, ClusterMixin
...
class BiclusterMixin:
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_dual.base import BaseEstimator, BiclusterMixin
...
class OneToOneFeatureMixin:
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_dual.base import OneToOneFeatureMixin
...
class ClassNamePrefixFeaturesOutMixin:
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_dual.base import ClassNamePrefixFeaturesOutMixin
...
class DensityMixin:
    ...
    Examples
    --------
    >>> from sklearn_dual.base import DensityMixin
...
class OutlierMixin:
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_dual.base import BaseEstimator, OutlierMixin
...
class MetaEstimatorMixin:
    ...
    Examples
    --------
    >>> from sklearn_dual.base import MetaEstimatorMixin
...
def is_classifier(estimator):
    ...
    Examples
    --------
    >>> from sklearn_dual.base import is_classifier
...
def is_regressor(estimator):
    ...
    Examples
    --------
    >>> from sklearn_dual.base import is_regressor
    >>> from sklearn_dual.cluster import KMeans
    >>> from sklearn_dual.svm import SVC, SVR
    >>> classifier = SVC()
    >>> regressor = SVR()
...
def is_clusterer(estimator):
    ...
    Examples
    --------
    >>> from sklearn_dual.base import is_clusterer
    >>> from sklearn_dual.cluster import KMeans
    >>> from sklearn_dual.svm import SVC, SVR
    >>> classifier = SVC()
    >>> regressor = SVR()
