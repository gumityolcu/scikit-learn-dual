...
import sklearn_dual
from sklearn_dual.base import BaseEstimator
from sklearn_dual.datasets import load_diabetes, load_iris, make_hastie_10_2
from sklearn_dual.dummy import DummyClassifier, DummyRegressor
...
from sklearn_dual.linear_model import LogisticRegression, Perceptron
from sklearn_dual.model_selection import GridSearchCV, ParameterGrid, train_test_split
from sklearn_dual.neighbors import KNeighborsClassifier, KNeighborsRegressor
from sklearn_dual.pipeline import make_pipeline
from sklearn_dual.preprocessing import FunctionTransformer, scale
from sklearn_dual.random_projection import SparseRandomProjection
from sklearn_dual.svm import SVC, SVR
from sklearn_dual.tree import DecisionTreeClassifier, DecisionTreeRegressor
from sklearn_dual.utils import check_random_state
from sklearn_dual.utils._testing import assert_array_almost_equal, assert_array_equal
from sklearn_dual.utils.fixes import CSC_CONTAINERS, CSR_CONTAINERS
