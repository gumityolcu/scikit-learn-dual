...
import sklearn_dual
from sklearn_dual import config_context, datasets
...
from sklearn_dual.utils._set_output import _get_output_config
...
def test_clone():
    ...
    from sklearn_dual.feature_selection import SelectFpr, f_classif
