...
import sklearn_dual
from sklearn_dual.utils._array_api import _check_array_api_dispatch
...
from sklearn_dual.utils.multiclass import check_classification_targets
...
def assert_allclose(
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_dual.utils._testing import assert_allclose
    >>> x = [1e-5, 1e-3, 1e-1]
