...
def lasso_path(
    ...
    **params : kwargs
    ...
    >>> import numpy as np
    >>> from sklearn_dual.linear_model import lasso_path
    ...
    >>> # same path
    >>> from sklearn_dual.linear_model import lars_path
...
def enet_path(
    ...
    **params : kwargs
    ...
    Examples
    --------
    >>> from sklearn_dual.linear_model import enet_path
...
class ElasticNetCV(RegressorMixin, LinearModelCV):
    ...
    Examples
    --------
    >>> from sklearn_dual.linear_model import ElasticNetCV
    >>> from sklearn_dual.datasets import make_regression
...
class MultiTaskLassoCV(RegressorMixin, LinearModelCV):
    ...
    Examples
    --------
    >>> from sklearn_dual.linear_model import MultiTaskLassoCV
    >>> from sklearn_dual.datasets import make_regression
