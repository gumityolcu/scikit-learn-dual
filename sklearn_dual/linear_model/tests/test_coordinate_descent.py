...
from sklearn_dual.base import clone, is_classifier
from sklearn_dual.datasets import load_diabetes, make_regression
...
from sklearn_dual.linear_model._coordinate_descent import _set_order
from sklearn_dual.model_selection import (
    BaseCrossValidator,
    GridSearchCV,
    LeaveOneGroupOut,
)
from sklearn_dual.model_selection._split import GroupsConsumerMixin
