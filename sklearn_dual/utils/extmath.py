...
def safe_sparse_dot(a, b, *, dense_output=False):
    ...
    >>> from sklearn_dual.utils.extmath import safe_sparse_dot
...
def randomized_range_finder(
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_dual.utils.extmath import randomized_range_finder
...
def weighted_mode(a, w, *, axis=0):
    ...
    Examples
    --------
    >>> from sklearn_dual.utils.extmath import weighted_mode
    >>> x = [4, 1, 4, 2, 4, 2]
    >>> weights = [1, 1, 1, 1, 1, 1]
...
def cartesian(arrays, out=None):
    ...
    Examples
    --------
    >>> from sklearn_dual.utils.extmath import cartesian
...
def safe_sqr(X, *, copy=True):
    ...
    Examples
    --------
    >>> from sklearn_dual.utils import safe_sqr
    >>> safe_sqr([1, 2, 3])
    array([1, 4, 9])
    """
...
def _approximate_mode(class_counts, n_draws, rng):
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_dual.utils.extmath import _approximate_mode
