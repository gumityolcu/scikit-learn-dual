...
import sklearn_dual
from sklearn_dual.base import BaseEstimator, ClassifierMixin, clone, is_regressor
from sklearn_dual.cluster import KMeans
from sklearn_dual.compose import make_column_transformer
from sklearn_dual.datasets import load_iris, make_classification, make_regression
...
from sklearn_dual.inspection._partial_dependence import (
    _grid_from_X,
    _partial_dependence_brute,
    _partial_dependence_recursion,
)
from sklearn_dual.linear_model import LinearRegression, LogisticRegression, MultiTaskLasso
...
from sklearn_dual.tree.tests.test_tree import assert_is_subtree
from sklearn_dual.utils._testing import assert_allclose, assert_array_equal
