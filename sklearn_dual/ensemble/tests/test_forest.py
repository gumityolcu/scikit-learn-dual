...
import sklearn_dual
from sklearn_dual import clone, datasets
from sklearn_dual.datasets import make_classification, make_hastie_10_2
...
from sklearn_dual.ensemble._forest import (
...
from sklearn_dual.model_selection import GridSearchCV, cross_val_score, train_test_split
from sklearn_dual.svm import LinearSVC
from sklearn_dual.tree._classes import SPARSE_SPLITTERS
...
from sklearn_dual.utils.multiclass import type_of_target
from sklearn_dual.utils.parallel import Parallel
...
def test_mse_criterion_object_segfault_smoke_test(Forest):
    ...
    from sklearn_dual.tree._criterion import MSE
