...
class FixedThresholdClassifier(BaseThresholdClassifier):
    ...
    >>> from sklearn_dual.model_selection import FixedThresholdClassifier, train_test_split
...
class TunedThresholdClassifierCV(BaseThresholdClassifier):
    ...
    >>> from sklearn_dual.model_selection import TunedThresholdClassifierCV, train_test_split
    >>> X, y = make_classification(
    ...     n_samples=1_000, weights=[0.9, 0.1], class_sep=0.8, random_state=42
    ... )
    >>> X_train, X_test, y_train, y_test = train_test_split(
