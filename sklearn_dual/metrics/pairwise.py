...
def nan_euclidean_distances(
    ...
    * John K. Dixon, "Pattern Recognition with Partly Missing Data",
    ...
    Examples
    --------
    >>> from sklearn_dual.metrics.pairwise import nan_euclidean_distances
    >>> nan = float("NaN")
    >>> X = [[0, 1], [1, nan]]
...
def pairwise_distances_argmin_min(
    ...
    Examples
    --------
    >>> from sklearn_dual.metrics.pairwise import pairwise_distances_argmin_min
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
...
def haversine_distances(X, Y=None):
    ...
    >>> from sklearn_dual.metrics.pairwise import haversine_distances
...
def manhattan_distances(X, Y=None):
    ...
    Examples
    --------
    >>> from sklearn_dual.metrics.pairwise import manhattan_distances
...
def cosine_distances(X, Y=None):
    ...
    Examples
    --------
    >>> from sklearn_dual.metrics.pairwise import cosine_distances
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
...
def paired_euclidean_distances(X, Y):
    ...
    Examples
    --------
    >>> from sklearn_dual.metrics.pairwise import paired_euclidean_distances
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
...
def paired_manhattan_distances(X, Y):
    ...
    Examples
    --------
    >>> from sklearn_dual.metrics.pairwise import paired_manhattan_distances
    >>> import numpy as np
...
def paired_cosine_distances(X, Y):
    ...
    Examples
    --------
    >>> from sklearn_dual.metrics.pairwise import paired_cosine_distances
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
...
def paired_distances(X, Y, *, metric="euclidean", **kwds):
    ...
    **kwds : dict
    ...
    Examples
    --------
    >>> from sklearn_dual.metrics.pairwise import paired_distances
    >>> X = [[0, 1], [1, 1]]
    >>> Y = [[0, 1], [2, 1]]
...
def linear_kernel(X, Y=None, dense_output=True):
    ...
    Examples
    --------
    >>> from sklearn_dual.metrics.pairwise import linear_kernel
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
    >>> linear_kernel(X, Y)
    array([[0., 0.],
...
def polynomial_kernel(X, Y=None, degree=3, gamma=None, coef0=1):
    ...
    Examples
    --------
    >>> from sklearn_dual.metrics.pairwise import polynomial_kernel
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
...
def sigmoid_kernel(X, Y=None, gamma=None, coef0=1):
    ...
    Examples
    --------
    >>> from sklearn_dual.metrics.pairwise import sigmoid_kernel
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
    >>> sigmoid_kernel(X, Y)
    array([[0.76..., 0.76...],
...
def rbf_kernel(X, Y=None, gamma=None):
    ...
    Examples
    --------
    >>> from sklearn_dual.metrics.pairwise import rbf_kernel
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
    >>> rbf_kernel(X, Y)
    array([[0.71..., 0.51...],
...
def laplacian_kernel(X, Y=None, gamma=None):
    ...
    Examples
    --------
    >>> from sklearn_dual.metrics.pairwise import laplacian_kernel
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
...
def cosine_similarity(X, Y=None, dense_output=True):
    ...
    Examples
    --------
    >>> from sklearn_dual.metrics.pairwise import cosine_similarity
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
...
def additive_chi2_kernel(X, Y=None):
    ...
    * Zhang, J. and Marszalek, M. and Lazebnik, S. and Schmid, C.
    ...
    Examples
    --------
    >>> from sklearn_dual.metrics.pairwise import additive_chi2_kernel
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
...
def chi2_kernel(X, Y=None, gamma=1.0):
    ...
    * Zhang, J. and Marszalek, M. and Lazebnik, S. and Schmid, C.
    ...
    Examples
    --------
    >>> from sklearn_dual.metrics.pairwise import chi2_kernel
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
    >>> chi2_kernel(X, Y)
    array([[0.36..., 0.13...],
...
def pairwise_distances_chunked(
    ...
    **kwds : optional keyword parameters
    ...
    >>> import numpy as np
    >>> from sklearn_dual.metrics import pairwise_distances_chunked
...
def pairwise_distances(
    ...
    **kwds : optional keyword parameters
    ...
    Examples
    --------
    >>> from sklearn_dual.metrics.pairwise import pairwise_distances
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
...
def pairwise_kernels(
    ...
    **kwds : optional keyword parameters
    ...
    Examples
    --------
    >>> from sklearn_dual.metrics.pairwise import pairwise_kernels
    >>> X = [[0, 0, 0], [1, 1, 1]]
    >>> Y = [[1, 0, 0], [1, 1, 0]]
