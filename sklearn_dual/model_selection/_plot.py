...
class LearningCurveDisplay(_BaseCurveDisplay):
    ...
    >>> from sklearn_dual.model_selection import LearningCurveDisplay, learning_curve
...
class ValidationCurveDisplay(_BaseCurveDisplay):
    ...
    >>> from sklearn_dual.model_selection import ValidationCurveDisplay, validation_curve
