...
class Hyperparameter(
    ...
    Examples
    --------
    >>> from sklearn_dual.gaussian_process.kernels import ConstantKernel
    >>> from sklearn_dual.datasets import make_friedman2
    >>> from sklearn_dual.gaussian_process import GaussianProcessRegressor
    >>> from sklearn_dual.gaussian_process.kernels import Hyperparameter
...
class Kernel(metaclass=ABCMeta):
    ...
    Examples
    --------
    >>> from sklearn_dual.gaussian_process.kernels import Kernel, RBF
    >>> import numpy as np
...
class CompoundKernel(Kernel):
    ...
    >>> from sklearn_dual.gaussian_process.kernels import CompoundKernel
...
class Sum(KernelOperator):
    ...
    >>> from sklearn_dual.datasets import make_friedman2
    >>> from sklearn_dual.gaussian_process import GaussianProcessRegressor
    >>> from sklearn_dual.gaussian_process.kernels import RBF, Sum, ConstantKernel
...
class Product(KernelOperator):
    ...
    >>> from sklearn_dual.datasets import make_friedman2
    >>> from sklearn_dual.gaussian_process import GaussianProcessRegressor
    >>> from sklearn_dual.gaussian_process.kernels import (RBF, Product,
    ...            ConstantKernel)
    >>> X, y = make_friedman2(n_samples=500, noise=0, random_state=0)
...
class ConstantKernel(StationaryKernelMixin, GenericKernelMixin, Kernel):
    ...
    >>> from sklearn_dual.datasets import make_friedman2
    >>> from sklearn_dual.gaussian_process import GaussianProcessRegressor
    >>> from sklearn_dual.gaussian_process.kernels import RBF, ConstantKernel
    >>> X, y = make_friedman2(n_samples=500, noise=0, random_state=0)
    >>> kernel = RBF() + ConstantKernel(constant_value=2)
    >>> gpr = GaussianProcessRegressor(kernel=kernel, alpha=5,
    ...         random_state=0).fit(X, y)
...
class WhiteKernel(StationaryKernelMixin, GenericKernelMixin, Kernel):
    ...
    >>> from sklearn_dual.datasets import make_friedman2
    >>> from sklearn_dual.gaussian_process import GaussianProcessRegressor
    >>> from sklearn_dual.gaussian_process.kernels import DotProduct, WhiteKernel
    >>> X, y = make_friedman2(n_samples=500, noise=0, random_state=0)
...
class PairwiseKernel(Kernel):
    ...
    >>> from sklearn_dual.datasets import load_iris
    >>> from sklearn_dual.gaussian_process import GaussianProcessClassifier
    >>> from sklearn_dual.gaussian_process.kernels import PairwiseKernel
    >>> X, y = load_iris(return_X_y=True)
