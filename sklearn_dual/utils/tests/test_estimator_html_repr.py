...
from sklearn_dual.cluster import AgglomerativeClustering, Birch
from sklearn_dual.compose import ColumnTransformer, make_column_transformer
from sklearn_dual.datasets import load_iris
from sklearn_dual.decomposition import PCA, TruncatedSVD
from sklearn_dual.ensemble import StackingClassifier, StackingRegressor, VotingClassifier
...
from sklearn_dual.multiclass import OneVsOneClassifier
from sklearn_dual.neural_network import MLPClassifier
from sklearn_dual.pipeline import FeatureUnion, Pipeline, make_pipeline
from sklearn_dual.preprocessing import FunctionTransformer, OneHotEncoder, StandardScaler
from sklearn_dual.svm import LinearSVC, LinearSVR
from sklearn_dual.tree import DecisionTreeClassifier
from sklearn_dual.utils._estimator_html_repr import (
    _get_css_style,
    _get_visual_block,
