...
def assert_all_finite(
    ...
    *,
    ...
    Examples
    --------
    >>> from sklearn_dual.utils import assert_all_finite
    >>> import numpy as np
...
def as_float_array(
    ...
    Examples
    --------
    >>> from sklearn_dual.utils import as_float_array
    >>> import numpy as np
...
def check_memory(memory):
    ...
    Examples
    --------
    >>> from sklearn_dual.utils.validation import check_memory
...
def check_consistent_length(*arrays):
    ...
    *arrays : list or tuple of input objects.
    ...
    Examples
    --------
    >>> from sklearn_dual.utils.validation import check_consistent_length
    >>> a = [1, 2, 3]
    >>> b = [2, 3, 4]
...
def indexable(*iterables):
    ...
    *iterables : {lists, dataframes, ndarrays, sparse matrices}
    ...
    Examples
    --------
    >>> from sklearn_dual.utils import indexable
...
def check_X_y(
    ...
    *,
    ...
    Examples
    --------
    >>> from sklearn_dual.utils.validation import check_X_y
    >>> X = [[1, 2], [3, 4], [5, 6]]
    >>> y = [1, 2, 3]
    >>> X, y = check_X_y(X, y)
    >>> X
...
def column_or_1d(y, *, dtype=None, warn=False):
    ...
    Examples
    --------
    >>> from sklearn_dual.utils.validation import column_or_1d
    >>> column_or_1d([1, 1])
    array([1, 1])
    """
...
def has_fit_parameter(estimator, parameter):
    ...
    >>> from sklearn_dual.utils.validation import has_fit_parameter
...
def check_symmetric(array, *, tol=1e-10, raise_warning=True, raise_exception=False):
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_dual.utils.validation import check_symmetric
...
def check_scalar(
    ...
    *,
    ...
    Examples
    --------
    >>> from sklearn_dual.utils.validation import check_scalar
...
def _check_psd_eigenvalues(lambdas, enable_warnings=False):
    ...
    Examples
    --------
    >>> from sklearn_dual.utils.validation import _check_psd_eigenvalues
...
def _to_object_array(sequence):
    ...
    --------
    >>> import numpy as np
    >>> from sklearn_dual.utils.validation import _to_object_array
