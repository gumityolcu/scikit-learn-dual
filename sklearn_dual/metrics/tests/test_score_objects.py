...
from sklearn_dual.linear_model import LogisticRegression, Perceptron, Ridge
...
from sklearn_dual.metrics import cluster as cluster_module
from sklearn_dual.metrics._scorer import (
...
from sklearn_dual.utils.metadata_routing import MetadataRouter, MethodMapping
