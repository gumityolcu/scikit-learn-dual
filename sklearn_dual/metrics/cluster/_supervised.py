...
def contingency_matrix(
    ...
    Examples
    --------
    >>> from sklearn_dual.metrics.cluster import contingency_matrix
...
def pair_confusion_matrix(labels_true, labels_pred):
    ...
    diagonal regardless of actual label values:
      ...
      >>> from sklearn_dual.metrics.cluster import pair_confusion_matrix
...
def rand_score(labels_true, labels_pred):
    ...
    Perfectly matching labelings have a score of 1 even
      ...
      >>> from sklearn_dual.metrics.cluster import rand_score
...
def adjusted_rand_score(labels_true, labels_pred):
    ...
    Perfectly matching labelings have a score of 1 even
      ...
      >>> from sklearn_dual.metrics.cluster import adjusted_rand_score
...
def homogeneity_completeness_v_measure(labels_true, labels_pred, *, beta=1.0):
    ...
    Examples
    --------
    >>> from sklearn_dual.metrics import homogeneity_completeness_v_measure
...
def homogeneity_score(labels_true, labels_pred):
    ...
    Perfect labelings are homogeneous::
      ...
      >>> from sklearn_dual.metrics.cluster import homogeneity_score
...
def completeness_score(labels_true, labels_pred):
    ...
    Perfect labelings are complete::
      ...
      >>> from sklearn_dual.metrics.cluster import completeness_score
...
def v_measure_score(labels_true, labels_pred, *, beta=1.0):
    ...
    Perfect labelings are both homogeneous and complete, hence have score 1.0::
      ...
      >>> from sklearn_dual.metrics.cluster import v_measure_score
...
def mutual_info_score(labels_true, labels_pred, *, contingency=None):
    ...
    Examples
    --------
    >>> from sklearn_dual.metrics import mutual_info_score
...
def adjusted_mutual_info_score(
    ...
    score 1.0::
      ...
      >>> from sklearn_dual.metrics.cluster import adjusted_mutual_info_score
...
def normalized_mutual_info_score(
    ...
    score 1.0::
      ...
      >>> from sklearn_dual.metrics.cluster import normalized_mutual_info_score
...
def fowlkes_mallows_score(labels_true, labels_pred, *, sparse=False):
    ...
    **False Negative** (i.e. the number of pair of points that belongs in the
    ...
    score 1.0::
      ...
      >>> from sklearn_dual.metrics.cluster import fowlkes_mallows_score
