...
from sklearn_dual.base import BaseEstimator, TransformerMixin, clone, is_classifier
from sklearn_dual.cluster import KMeans
from sklearn_dual.datasets import load_iris
from sklearn_dual.decomposition import PCA, TruncatedSVD
...
from sklearn_dual.exceptions import NotFittedError, UnsetMetadataPassedError
...
from sklearn_dual.linear_model import Lasso, LinearRegression, LogisticRegression
from sklearn_dual.metrics import accuracy_score, r2_score
from sklearn_dual.model_selection import train_test_split
from sklearn_dual.neighbors import LocalOutlierFactor
from sklearn_dual.pipeline import FeatureUnion, Pipeline, make_pipeline, make_union
from sklearn_dual.preprocessing import FunctionTransformer, StandardScaler
...
from sklearn_dual.utils._metadata_requests import COMPOSITE_METHODS, METHODS
