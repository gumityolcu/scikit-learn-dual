...
class ExtraTreeClassifier(DecisionTreeClassifier):
    ...
    >>> from sklearn_dual.ensemble import BaggingClassifier
    >>> from sklearn_dual.tree import ExtraTreeClassifier
...
class ExtraTreeRegressor(DecisionTreeRegressor):
    ...
    >>> from sklearn_dual.datasets import load_diabetes
    >>> from sklearn_dual.model_selection import train_test_split
    >>> from sklearn_dual.ensemble import BaggingRegressor
    >>> from sklearn_dual.tree import ExtraTreeRegressor
    >>> X, y = load_diabetes(return_X_y=True)
    >>> X_train, X_test, y_train, y_test = train_test_split(
    ...     X, y, random_state=0)
